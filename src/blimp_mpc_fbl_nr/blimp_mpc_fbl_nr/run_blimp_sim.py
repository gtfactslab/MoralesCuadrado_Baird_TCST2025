...
def main(args=sys.argv):
    ...
    mapping = {        
        'hardware_nr_circle_horz' : HardwareWardiCircleHorz,
        'hardware_nr_circle_vert' : HardwareWardiCircleVert,
        'hardware_nr_fig8_horz' : HardwareWardiFig8Horz,
        'hardware_nr_fig8_vert_short' : HardwareWardiFig8VertShort,
        'hardware_nr_fig8_vert_tall' : HardwareWardiFig8VertTall,
        'hardware_nr_circle_horz_spin' : HardwareWardiCircleHorzSpin,
        'hardware_nr_helix' : HardwareWardiHelix,
        'hardware_nr_helix_spin' : HardwareWardiHelixSpin,

        'hardware_mpc_circle_horz' : HardwareCasadiCircleHorz,
        'hardware_mpc_circle_vert' : HardwareCasadiCircleVert,
        'hardware_mpc_fig8_horz' : HardwareCasadiFig8Horz,
        'hardware_mpc_fig8_vert_short' : HardwareCasadiFig8VertShort,
        'hardware_mpc_fig8_vert_tall' : HardwareCasadiFig8VertTall,
        'hardware_mpc_circle_horz_spin' : HardwareCasadiCircleHorzSpin,
        'hardware_mpc_helix' : HardwareCasadiHelix,
        'hardware_mpc_helix_spin' : HardwareCasadiHelixSpin,

        'hardware_fbl_circle_horz' : HardwareCBFCircleHorz,
        'hardware_fbl_circle_vert' : HardwareCBFCircleVert,
        'hardware_fbl_fig8_horz' : HardwareCBFFig8Horz,
        'hardware_fbl_fig8_vert_short' : HardwareCBFFig8VertShort,
        'hardware_fbl_fig8_vert_tall' : HardwareCBFFig8VertTall,
        'hardware_fbl_circle_horz_spin' : HardwareCBFCircleHorzSpin,
        'hardware_fbl_helix' : HardwareCBFHelix,
        'hardware_fbl_helix_spin' : HardwareCBFHelixSpin,
